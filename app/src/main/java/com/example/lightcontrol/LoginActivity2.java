        ...
        eLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(userName.isEmpty() || userPassword.isEmpty())
                {
                    ...
                    Toast.makeText(LoginActivity2.this, "Please enter name and password!", Toast.LENGTH_LONG).show();
                    ...
                    if (!isValid) {
                        ...
                        if (counter == 0) {
                            ...
                            Toast.makeText(LoginActivity2.this, "You have used all your attempts try again later!", Toast.LENGTH_LONG).show();
                        }
                        /* Display error message */
                        else {
                            Toast.makeText(LoginActivity2.this, "Incorrect credentials, please try again!", Toast.LENGTH_LONG).show();
                        }
                    }
                    /* If valid */
                    else {
